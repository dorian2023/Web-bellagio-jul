        ...
        {isStandalonePage && (
          <div className="stores-vip-banner">
            <div className="stores-vip-content">
              <span className="stores-vip-label">Servicio Exclusivo Bellagio</span>
              <h3 className="stores-vip-title">¿Deseas una Asesoría de Interiorismo In-Situ?</h3>
              <p className="stores-vip-desc">
                Coordina una visita guiada con nuestros diseñadores en el showroom de tu preferencia. Te presentaremos catálogos de maderas nobles, cueros seleccionados y configuraciones 3D para tu espacio.
              </p>
              <div className="stores-vip-perks">
                ...
                <div className="vip-perk-item">
                  <span className="vip-perk-icon">✓</span>
                  <span>Muestrario de 120+ acabados y telas</span>
                </div>
                <div className="vip-perk-item">
                  <span className="vip-perk-icon">✓</span>
                  <span>Renders y cotización formal inmediata</span>
                </div>
              </div>
            </div>
            <div className="stores-vip-cta-box">
              <a 
                href="https://wa.me/584141536516?text=Hola%20Muebles%20Bellagio%2C%20deseo%20agendar%20una%20visita%20guiada%20VIP%20en%20uno%20de%20sus%20showrooms."
                target="_blank"
                rel="noopener noreferrer"
                className="btn btn-whatsapp stores-vip-btn"
              >
                Agendar Cita VIP en Showroom
              </a>
            </div>
          </div>
        )}
